...
class ProductDetailWeb extends ConsumerStatefulWidget {
  ...
  const ProductDetailWeb({super.key, required this.productDetailModel});

  @override
  ConsumerState<ProductDetailWeb> createState() => _ProductDetailState();
}

class _ProductDetailState extends ConsumerState<ProductDetailWeb> {
  bool active1 = false;
  bool active2 = false;
